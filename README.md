# Awesome Vehicle Re-ID Collection with stars
...
:helicopter:  Drone-based building re-id (ACM Multimedia 2020) [\[code\]](https://github.com/layumi/University1652-Baseline) ⭐ 672 | 🐛 34 | 🌐 Python | 📅 2026-08-10  [\[paper\]](https://arxiv.org/abs/2002.12186)

GPU-based Fast Re-Ranking [\[code\]](https://github.com/layumi/Person_reID_baseline_pytorch/tree/master/GPU-Re-Ranking) ⭐ 4,447 | 🐛 174 | 🌐 Python | 📅 2026-07-18 [\[paper\]](https://arxiv.org/abs/2012.07620v2)
...
2. Counterfactual Attention Learning for Fine-Grained Visual Categorization and Re-identification **(ICCV)**
   ...
   [code](https://github.com/raoyongming/CAL) ⭐ 159 | 🐛 9 | 🌐 Python | 📅 2023-01-05

3. Heterogeneous Relational Complement for Vehicle Re-identification **(ICCV)**
   ...
   [code](https://github.com/iCVTEAM/HRCN) ⭐ 23 | 🐛 3 | 🌐 Python | 📅 2021-10-10
...
4. PhD Learning: Learning With Pompeiu-Hausdorff Distances for Video-Based Vehicle Re-Identification **(CVPR)**
   ...
   [code](https://github.com/emdata-ailab/PhD-Learning) ⭐ 17 | 🐛 2 | 🌐 Python | 📅 2021-04-12

5. Viewpoint and Scale Consistency Reinforcement for UAV Vehicle Re-Identification **(IJCV)**
   [pdf](https://link.springer.com/content/pdf/10.1007/s11263-020-01402-2.pdf)

6. Exploring Spatial Significance via Hybrid Pyramidal Graph Network for Vehicle Re-Identification **(TITS)**
   [paper](https://ieeexplore.ieee.org/abstract/document/9457192)

7. Model Latent Views With Multi-Center Metric Learning for Vehicle Re-Identification **(TITS)**
   [paper](https://ieeexplore.ieee.org/document/9325909/)

8. Inter-Domain Adaptation Label for Data Augmentation in Vehicle Re-identification **(TMM)**
   [paper](https://ieeexplore.ieee.org/abstract/document/9513554)

9. Learning Multiple Semantic Knowledge For Cross-Domain Unsupervised Vehicle Re-Identification **(ICME)**
   [paper](https://ieeexplore.ieee.org/abstract/document/9428440)

10. Multi-level Deep Learning Vehicle Re-identification using Ranked-based Loss Functions **(ICPR)**
    [paper](https://ieeexplore.ieee.org/abstract/document/9412415)

11. Keypoint-Aligned Embeddings for Image Retrieval and Re-Identification **(WACV)**
...
12. Pseudo Graph Convolutional Network for Vehicle ReID **(ACMMM)**
    [paper](https://dl.acm.org/doi/abs/10.1145/3474085.3475462)

13. Vehicle Re-identification for Lane-level Travel Time Estimations on Congested Urban Road Networks Using Video Images **(TITS)**
    [paper](https://ieeexplore.ieee.org/abstract/document/9569748)

14. OERFF: A Vehicle Re-Identification Method Based on Orientation Estimation and Regional Feature Fusion **(IEEE Access)**
...
5. Orientation-aware Vehicle Re-identification with Semantics-guided Part Attention Network **(ECCV)**
   [pdf](https://paperswithcode.com/paper/orientation-aware-vehicle-re-identification)
   [code](https://github.com/tsaishien-chen/SPAN) ⭐ 26 | 🐛 3 | 🌐 Python | 📅 2021-06-08

6. Group-Group Loss-Based Global-Regional Feature Learning for Vehicle Re-Identification **(TIP)**
   [paper](https://ieeexplore.ieee.org/document/8897720)
   [code](https://github.com/liu-xb/GGL) ⭐ 12 | 🐛 0 | 🌐 C++ | 📅 2022-05-10

7. VehicleNet: Learning Robust Visual Representation for Vehicle Re-identification **(TMM)**
   [arXiv](https://arxiv.org/abs/2004.06305)
   [\[中文介绍\]](https://zhuanlan.zhihu.com/p/186905783)

8. The Devil is in the Details: Self-Supervised Attention for Vehicle Re-Identification **(ECCV)**
   [arXiv](https://arxiv.org/abs/2004.06271)
   [\[中文介绍\]](https://zhuanlan.zhihu.com/p/191654655)

9. Structural Analysis of Attributes for Vehicle Re-Identification and Retrieval **(TITS)**
